...
- **NO incluir sección CRITICAL FLOWS.** Esta sección fue eliminada del estándar de Cake. Solo incluirla si el PO la pide explícitamente en el input.
...
2. **Execute:** Redacta el ticket completo: primero TODO en inglés, luego el separador `════...ESPAÑOL...════`, luego TODO en español. Para US usa criterios medibles (sin sección CRITICAL FLOWS). Para Design Task usa criterios de entrega visual.
