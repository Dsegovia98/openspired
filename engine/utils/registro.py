...
from config import PROJECT_ROOT, WORKSPACE_DIR, DOMAIN_PRIMARY, DOMAIN_SECONDARY
...
def next_ticket_id(ticket_type: str, domain: str) -> str:
    """Genera el siguiente ID disponible para el tipo y dominio dados."""
    prefix  = _build_prefix(ticket_type, domain)
...
def register_ticket(
    ...
    with _file_lock(REGISTRO_PATH):
        _register_ticket_locked(ticket_id, ticket_name, domain, module, ticket_type, file_path)
